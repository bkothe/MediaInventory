...
namespace MediaInventory.Tests.Unit.Core.Venue
{
    ...
    public class VenueValidatorTests
    {
        ...
        {
            _venueValidator.Validate(new MediaInventory.Core.Venue.Venue
            {
                Name = "The Vic",
                State = "IL",
                City = "Chicago"
        ...
        public void should_have_error_when_name_exists_with_different_id()
        {
            ...
            _venues.Add(new MediaInventory.Core.Venue.Venue { Name = name });
        ...
        {
            var artist = _venues.Add(new MediaInventory.Core.Venue.Venue { Id = Guid.NewGuid(), Name = "The Vic" });
