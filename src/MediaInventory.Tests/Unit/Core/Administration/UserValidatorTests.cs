...
namespace MediaInventory.Tests.Unit.Core.Administration
{
    ...
    public class UserValidatorTests
    {
        ...
        public void SetUp()
        {
            ...
            _sut = new UserValidator(_users);
        }

        [Test]
        public void should_not_have_error_for_valid_user()
        {
            _sut.Validate(new User
            {
        ...
        {
            _sut.ShouldHaveValidationErrorFor(x => x.EmailAddress, emailAddress);
        }

        [Test]
        public void should_not_have_error_when_email_address_is_valid()
        {
            _sut.ShouldNotHaveValidationErrorFor(x => x.EmailAddress, "geddy.lee@example.org");
        }
        ...
        {
            _sut.ShouldHaveValidationErrorFor(x => x.EmailAddress, ($"{new string('x', length-4)}@x.l"));
        }
        ...
        {
            _sut.ShouldNotHaveValidationErrorFor(x => x.EmailAddress, ($"{new string('x', length - 4)}@x.l"));
        }
        ...
        public void should_not_have_error_when_email_address_exists_with_for_same_user()
        {
            ...
            _sut.ShouldNotHaveValidationErrorFor(x => x.EmailAddress, user);
        }
        ...
        {
            _sut.ShouldHaveValidationErrorFor(x => x.FirstName, new string('x', 26));
        }
        ...
        {
            _sut.ShouldNotHaveValidationErrorFor(x => x.FirstName, new string('x', length));
        }
        ...
        {
            _sut.ShouldHaveValidationErrorFor(x => x.LastName, new string('x', 26));
        }
        ...
        {
            _sut.ShouldNotHaveValidationErrorFor(x => x.LastName, new string('x', length));
        }
    }
}